  ...
  Future<String> getUserRoleByUserEmail(String email) async {
    try {
      QuerySnapshot querySnapshot = await user
          ...
          .limit(1)
          .get();
      print('[getUserRoleByUserEmail] querySnapshot.docs: ${querySnapshot.docs}');
  ...
  Future<User?> signUp(String email, String password, String username, String role) async {
    try {
      ...
      await user.add({
        ...
        'user_image': 'https://static.vecteezy.com/system/resources/previews/009/292/244/non_2x/default-avatar-icon-of-social-media-user-vector.jpg',
      });
